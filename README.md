## 이더리움 기반의 솔리디티 언어를 이용한 스마트 컨트렉트 사설넷에 인스톨 한 후 

## nodejs와 mysql 과의 연동을 하는 프로젝트를 구현



### 사설넷은 truffle develop 명령을 이용해서 10개의 계정을 가진 사설넷을 이용한다.
...
![image-20201208171332376](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208171332376.png)

위와 같은 구조의 프레임워크 생성

contracts/busSafe.sol 생성후 계약 작성
...
ganache 프로그램을 이용해서 사설넷을 띄우고 그 네트워크에 스마트 컨트렉트를  install 한다.



https://www.trufflesuite.com/ganache 접속후 

각 os버전에 맞게 설치 한다.

설치한 후 ganache 실행하면 다음과 같은 프로그램이 열리면서 127.0.0.1:7545 로 열리는 사설넷이 구성된다.

![image-20201212123458862](https://user-images.githubusercontent.com/75194770/101971676-8e87bd00-3c76-11eb-9923-62e44fa14e8b.png)
...
```
truffle(development)> complie
truffle(development)> migrate --reset
```

![image-20201208173116923](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208173116923.png)
...
![image-20201212143458875](https://user-images.githubusercontent.com/75194770/101976293-3d33f980-3c87-11eb-89c4-4ea30fe3efb2.png)
...
##### set method : 서버가 실행될때 처음 한번 세팅되는 부분

##### use method : middleware 등록 하는 부분 

##### listen method : 서버를 특정한 포트와 url 가진 서버가 실행되게 하는 부분
...
signup.ejs파일을 document 로 변환해서 요청클라이언트에게 전송되도록 한다.
...
#### index.js에서 router.js를 import 해서 미들웨어로 등록한다.
...
mysql DATABASE 생성하기 위해 mysqlworkbench 다음과 같은 sql query문을 이용하여 생성한다.
...
> create table bussafe.user_list (
...
> create table bussafe.car_list (
car_id varchar(32) primary key, 
car_div varchar(32) not null, 
car_type varchar(32) not null, 
car_birth varchar(32) not null, 
car_day varchar(32) not null, 
car_result varchar(32) not null);
...
signup이 성공하면 login page가 보이도록 하기위해 router.js에서 router.post("/signup"........)

부분에서  다음과 같이  res.send() 부분을 redirect("/login") 수정한다.
...
```javascript
router.get("/check_list/:car_id", function (req, res) {
...
...
var product_contract = require("../build/contracts/busSafe.json");
...
![image-20201208213253741](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208213253741.png)
...
![image-20201208214028395](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208214028395.png)
...
![image-20201208215650171](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208215650171.png)
...
![image-20201208220203793](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208220203793.png)
...
![image-20201208220705688](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208220705688.png)
...
![image-20201208221119956](C:\Users\82108\AppData\Roaming\Typora\typora-user-images\image-20201208221119956.png)
